<section class="container">
    ...
    <form action="index.php?page=Mantenimientos-Cinventario&mode={{mode}}&id_prod={{id_prod}}" method="POST">
        ...
        <div> 
            ...
            <input type="text" name="prod_cod_barra" id="prod_cod_barra" value="{{prod_cod_barra}}" {{readonly}} /> 
        </div>
        ...
        <div> 
            ...
            <input type="number" name="prod_precio_compra" id="prod_precio_compra" min="0.01" step="0.01" value="{{prod_precio_compra}}" {{readonly}} /> 
        </div>
        
        <div> 
            <label for="prod_precio_venta">Precio Venta</label> 
            <input type="number" name="prod_precio_venta" id="prod_precio_venta" min="0.01" step="0.01" value="{{prod_precio_venta}}" {{readonly}} /> 
        </div>
